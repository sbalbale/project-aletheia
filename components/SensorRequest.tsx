...
export default function SensorRequest() {
  ...
  return (
    <div className="w-full flex justify-center py-2 relative md:fixed md:bottom-20 md:left-1/2 md:-translate-x-1/2 z-50">
      <button
        onClick={requestAccess}
        className="bg-red-500/20 hover:bg-red-500/40 text-red-400 border border-red-500/50 px-4 py-2 rounded font-mono text-xs backdrop-blur-sm transition-colors animate-pulse [animation-duration:4s]"
      >
        [ ENABLE SENSORS ]
      </button>
    </div>
